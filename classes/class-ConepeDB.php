<?php
/**
 * ConepeDB - Classe para gerenciamento da base de dados
 *
 * @package ConepeApp
 * @since 0.1
 */
class ConepeDB
{
	...
	public $host      = 'localhost', 	// Host da base de dados 
	       $db_name   = 'bznlqzus_conepedb',    	// Nome do banco de dados
	       $password  = 'conepe2017',  	// Senha do usuário da base de dados
	       $user      = 'bznlqzus_root',      	// Usuário da base de dados
	...
	final protected function connect() {
		...
		try {
			...
			if ( $this->debug === true ) {
				...
				echo "Erro: " . $e->getMessage() . "<br/>host: " . $this->host . 
				"<br/>db_name: " . $this->db_name . 
...
function test_print($item2, $key)
{
	...
	public function update( $table, $where_field, $where_field_value, $values ) {
		...
		//echo $stmt . " values " . var_dump($values) . "</br>";
